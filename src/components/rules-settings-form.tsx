    ...
    <form className="grid" style={{ gap: 14 }} onSubmit={onSubmit}>
      <div className="grid" style={{ gap: 10 }}>
        ...
        <label className="grid" style={{ gap: 6 }}>
          <span className="meta">Out of Flow if no movement for (days)</span>
          <input
            className="input"
            type="number"
            min={1}
        ...
        <label className="grid" style={{ gap: 6 }}>
          <span className="meta">Flow Stage grace days (beyond expected duration)</span>
          <input
            className="input"
            type="number"
            min={0}
      ...
      <div className="grid" style={{ gap: 10 }}>
        ...
        <label className="grid" style={{ gap: 6 }}>
          <span className="meta">Flow Risk Window (hours)</span>
          <input
            className="input"
            type="number"
            min={1}
      ...
      <div className="grid" style={{ gap: 10 }}>
        ...
        <label className="grid" style={{ gap: 6 }}>
          <span className="meta">Flow Lifecycle Limit (days)</span>
          <input
            className="input"
            type="number"
            min={1}
        ...
        <label className="grid" style={{ gap: 6 }}>
          <span className="meta">Flow Breakdown threshold (days)</span>
          <input
            className="input"
            type="number"
            min={1}
        ...
        <label className="row" style={{ gap: 8, alignItems: "center" }}>
          ...
          />
          <span className="meta">Include overdue Flow Steps in Flow Breakdown reasons</span>
        </label>
        <label className="row" style={{ gap: 8, alignItems: "center" }}>
          <input
            type="checkbox"
          ...
          />
          <span className="meta">Include Flow Lifecycle limit in Flow Breakdown reasons</span>
        </label>
      </div>
